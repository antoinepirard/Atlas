    ...
    >
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-stone-500">
          Write these words down and store them safely. If you forget your
          password, this is the only way to recover your vault.
        </p>
      </div>
      ...
      <div className="bg-amber-50 rounded-xl p-4 border border-amber-100">
        <p className="text-xs text-amber-800">
          <strong>Important:</strong> Never share this phrase with anyone.
          Anyone with these words can access your vault. We cannot recover this
          phrase for you.
        </p>
      </div>
        ...
        {step === "password" ? (
          ...
          >
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-stone-500">
                Your thoughts deserve privacy. Create a password to encrypt
                everything you save.
              </p>
            </div>
